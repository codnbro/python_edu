    ...
    def run(self):
        ...
        while True:
            ...
            if cur_min_dt > self.df.index[-1]:
                ...
                self.df.loc[last_index, 'Close'] = price
                if price > self.df.loc[last_index, 'High']:
                    self.df.loc[last_index, 'High'] = price
                if price < self.df.loc[last_index, 'Low']:
                    self.df.loc[last_index, 'Low'] = price
